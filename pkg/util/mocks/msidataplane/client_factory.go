...
//
//	mockgen -imports=internal=github.com/Azure/msi-dataplane/pkg/dataplane -destination=../mocks/msidataplane/client_factory.go github.com/Azure/msi-dataplane/pkg/dataplane ClientFactory
//
